$('.center').slick({
  ...
  lang.forEach(item => {
      item.addEventListener('click',(e) => {
          ...
          if(id === 'az'){
            header.innerHTML = 'ŞƏHID HEYKƏLTƏRAŞ SAMIR KAÇAYEVIN “KÜLƏKLƏ SOVRULMUŞLAR” ƏSƏRI'
            p1.innerHTML = 'TORPAQLARIMIZIN BÜTÖVLÜYÜ UĞRUNDA ŞƏHID OLMUŞ HEYKƏLTƏRAŞ SAMIR KAÇAYEV 1994-CÜ ILDƏ ŞAMAXI RAYONUNUN ÇUXURYURD KƏNDINDƏ DOĞULMUŞDUR. O, 2015-CI ILDƏ AZƏRBAYCAN DÖVLƏT RƏSSAMLIQ AKADEMIYASINI HEYKƏLTƏRAŞLIQ IXTISASI ÜZRƏ MÜVƏFFƏQIYYƏTLƏ BITIRIB MAGISTRATURAYA DAXIL OLUR. O, TƏHSILINI YARIMÇIQ QOYARAQ HƏRBI XIDMƏTƏ YOLLANIR VƏ 2016-CI ILIN APREL DÖYÜŞLƏRINDƏ ŞƏHIDLIK ZIRVƏSINƏ YÜKSƏLIR. SAMIR KAÇAYEV GÖSTƏRDIYI RƏŞADƏTƏ GÖRƏ ÖLÜMÜNDƏN SONRA AZƏRBAYCAN RESPUBLIKASININ PREZIDENTI, ALI BAŞ KOMANDAN CƏNAB İLHAM ƏLIYEVIN SƏRƏNCAMI ILƏ “İGIDLIYƏ GÖRƏ” MEDALI ILƏ TƏLTIF EDILMIŞDIR.'
            p2.innerHTML = 'SAMIR YAŞADIĞI QISA ÖMÜR ƏRZINDƏ BÖYÜK IŞLƏR GÖRMƏYƏ MÜVƏFFƏQ OLMUŞDUR. O, YARATDIĞI ƏSƏRLƏRI, SƏNƏTƏ BAXIŞI, INSANLARA MÜNASIBƏTI, VƏTƏNƏ SEVGISI ILƏ ONU TANIYANLARIN RƏĞBƏT VƏ MƏHƏBBƏTINI QAZANMIŞDIR'
        }else if(id === 'en'){
